...
// tím) để bé biết chơi tiếp; các truyện xa hơn tạm khoá 🔒. Bấm một truyện đã mở → sang
// màn chơi (/vietnamese/story/<id>). Tiến độ lưu theo từng bé (localStorage).
...
export default function StoryMapPage() {
  ...
  return (
    <main className="wrap smap-wrap">
      ...
      <p className="page-eyebrow smap-eyebrow">NGHE HIỂU CÂU CHUYỆN</p>
      <h1 className="page-title smap-title">Bản đồ kể chuyện của bé 🐰</h1>
      <p className="page-sub smap-sub">Nghe rồi xếp tranh đúng thứ tự để mở truyện tiếp theo nhé!</p>
